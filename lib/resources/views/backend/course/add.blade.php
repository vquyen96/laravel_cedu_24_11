                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="cou_price" placeholder="300000" required>
                        </div>

                        @if (Auth::user()->level < 6)
                            <div class="form-group">
                                <label>Giá chưa sale</label>
                                <input type="number" class="form-control" name="cou_price_old"  placeholder="600000" >
                            </div>
                            <div class="form-group">
                                <label>Sale</label>
                                <input type="number" class="form-control" name="cou_sale" placeholder="VD: 15%" >
                            </div>
                            <div class="form-group">
